    ...
    <form className={classes.form} onSubmit={confirmHandler}>
      <div className={nameControlClasses}>
        ...
        {!formInputIsValid.name && (
          <p>Field cannot be blank. Please enter your name.</p>
        )}
      </div>
      <div className={streetControlClasses}>
        ...
        {!formInputIsValid.street && (
          <p>Field cannot be blank. Please enter a valid street address.</p>
        )}
      </div>
      <div className={cityControlClasses}>
        ...
        {!formInputIsValid.city && (
          <p>Field cannot be blank. Please enter a valid city.</p>
        )}
      </div>
      <div className={postalCodeControlClasses}>
        ...
        {!formInputIsValid.postalCode && (
          <p>Postal Code must be exactly 5 digits. No more. No less.</p>
        )}
      </div>
